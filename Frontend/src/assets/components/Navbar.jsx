    ...
    <>
      <div className="navbar bg-base-100 sticky top-0 z-50 ">
        ...
        <div className="navbar-start">
          <Menu as={`div`} className="dropdown flex sm:hidden">
            {!toggle ? (
              <Menu.Button
                id="menu-btn"
              ...
              >
                {!userLogin && (
                  <React.Fragment>
                    ...
                    <Link
                      to={`/register`}
                      className="group flex w-full items-center rounded-md px-2 py-2 text-sm text-white bg-slate-600"
                    >
                      Get started
                    </Link>
                  </React.Fragment>
          ...
          <Link to={'/'} className="normal-case text-xl ml-3 font-semibold">myBlog</Link>
        </div>
